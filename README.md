  ...
  <tr>
    ...
    <td>
      ...
      <table>
        <tr>
          <td>
            <img src="https://github.com/kwokcb/materialxMaterials/blob/main/data/PhysicallyBasedMaterialX/Ketchup.png?raw=true" width=256px><br>
            Ketchup
          </td>
          <td>
            <img src="https://github.com/kwokcb/materialxMaterials/blob/main/data/PhysicallyBasedMaterialX/Cooking_Oil.png?raw=true" width=256px><br>
            Cooking Oil
          </td>
          <td>
            <img src="https://github.com/kwokcb/materialxMaterials/blob/main/data/PhysicallyBasedMaterialX/Brass.png?raw=true" width=256px><br>
            Brass
          </td>
        </tr>
      </table>
  ...
  <tr>
    <td>
      ...
      <table>
        <tr>
          <td>
            <img src="https://github.com/kwokcb/materialxMaterials/blob/main/data/ambientCgMaterials/Metal053C_1K-PNG.png?raw=true" width=256px><br>
            Metal (53)
          </td>
          <td>
            <img src="https://github.com/kwokcb/materialxMaterials/blob/main/data/ambientCgMaterials/PavingStones142_1K-PNG.png?raw=true" width=256px><br>
            Paving Stones (142)
          </td>
          <td>
            <img src="https://github.com/kwokcb/materialxMaterials/blob/main/data/ambientCgMaterials/WoodFloor038_1K-PNG.png?raw=true" width=256px><br>
            Wood Floor (38)
          </td>
        </tr>
      </table>
...
- `build_download.sh` will use the installed pack to download sample materials.
