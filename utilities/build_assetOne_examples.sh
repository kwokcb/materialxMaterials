...
python3 src/materialxMaterials/assetOneCmd.py --listTypes=True -o examples/assetOne -st types.json
cat >> examples/assetOne/README.md << 'README_EOF'
| `types.json` | List of asset types | `--listTypes=True` |
README_EOF

# 1c. Query creators
python3 src/materialxMaterials/assetOneCmd.py --listCreators=True -o examples/assetOne -sc creators.json
cat >> examples/assetOne/README.md << 'README_EOF'
| `creators.json` | List of asset creators | `--listCreators=True` |
README_EOF

# 1d. Search by keyword / tag
python3 src/materialxMaterials/assetOneCmd.py -q=wood -l=10 -o examples/assetOne -sa search_wood_assets.json
cat >> examples/assetOne/README.md << 'README_EOF'
| `search_wood_assets.json` | Query for first 10 items with "wood" | `-q=wood -l=10` |
README_EOF

python3 src/materialxMaterials/assetOneCmd.py -q=marble -l=10 -o examples/assetOne -sa search_marble_assets.json
cat >> examples/assetOne/README.md << 'README_EOF'
| `search_marble_assets.json` | Query for first 10 items with "marble" | `-q=marble -l=10` |
README_EOF

python3 src/materialxMaterials/assetOneCmd.py -q=brick -l=10 -o examples/assetOne -sa search_brick_assets.json
cat >> examples/assetOne/README.md << 'README_EOF'
...
python3 src/materialxMaterials/assetOneCmd.py -c=ambientcg -l=10 -o examples/assetOne -sa creator_ambientcg_assets.json
cat >> examples/assetOne/README.md << 'README_EOF'
| `creator_ambientcg_assets.json` | Query for first 10 items by creator "ambientcg" | `-c=ambientcg -l=10` |
README_EOF

python3 src/materialxMaterials/assetOneCmd.py -c=polyhaven -l=10 -o examples/assetOne -sa creator_polyhaven_assets.json
cat >> examples/assetOne/README.md << 'README_EOF'
...
python3 src/materialxMaterials/assetOneCmd.py -t=hdri -l=10 -o examples/assetOne -sa type_hdri_assets.json
cat >> examples/assetOne/README.md << 'README_EOF'
| `type_hdri_assets.json` | Query for first 10 items of type "hdri" | `-t=hdri -l=10` |
README_EOF

python3 src/materialxMaterials/assetOneCmd.py -t=3d-model -l=10 -o examples/assetOne -sa type_3d_model_assets.json
cat >> examples/assetOne/README.md << 'README_EOF'
...
python3 src/materialxMaterials/assetOneCmd.py -q=brick -c=polyhaven -t=pbr-material -l=10 -o examples/assetOne -sa search_brick_polyhaven_pbr_assets.json
cat >> examples/assetOne/README.md << 'README_EOF'
...
python3 src/materialxMaterials/assetOneCmd.py -id=1,2,349 -o examples/assetOne -sa ids_1_2_349_assets.json
cat >> examples/assetOne/README.md << 'README_EOF'
...
python3 src/materialxMaterials/assetOneCmd.py --downloadRSS=True > examples/assetOne/assets_feed.xml
cat >> examples/assetOne/README.md << 'README_EOF'
