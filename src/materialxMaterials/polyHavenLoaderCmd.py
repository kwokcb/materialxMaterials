...
def main():
    ...
    if fetch:
        ...
        #print(f"MaterialX assets: {json_string}")
    ...
    if download_id:
        ...
        if entry:
            print(f"Downloading asset with ID '{download_id}', resolution '{resolution}'")
            ...
            print(f"No asset found with ID '{entry_id}' in the MaterialX assets.")
