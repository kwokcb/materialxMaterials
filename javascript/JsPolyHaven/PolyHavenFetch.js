/**
 * PolyHavenAPI - A JavaScript class for interacting with the Poly Haven API
...
class PolyHavenAPI {
     ...
     * @returns {Promise<Object>} MaterialX files data
     */
     ...
     * @param {string} url - MaterialX file URL
     * @returns {Promise<string>} MaterialX file content
     */
     ...
     * @returns {Promise<Blob>} Texture file blob
     */
     ...
     * @param {string} resolution - Resolution (1k, 2k, 4k, 8k)
     * @returns {Promise<Blob>} ZIP file blob containing the complete package
     */
     ...
     * @param {string} resolution - Resolution (1k, 2k, 4k, 8k)
     * @returns {Promise<Object>} Object containing MaterialX content and texture files
     */
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = PolyHavenAPI;
} else if (typeof window !== 'undefined') {
    window.PolyHavenAPI = PolyHavenAPI;
}
